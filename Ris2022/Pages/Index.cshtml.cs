...
namespace Ris2022.Pages.Account
{
    public class LoginIModel : PageModel
    {
        ...
        private readonly ILogger<LoginIModel> _logger;

        public LoginIModel(SignInManager<RisAppUser> signInManager, ILogger<LoginIModel> logger)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    Log.Error($"Invalid login attempt to {Input.UserName} User");
                    return Page();
                }
            }
